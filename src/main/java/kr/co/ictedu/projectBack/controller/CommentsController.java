...
//	public ResponseEntity<?> commentsAdd(CommentsVO vo, HttpServletRequest request) {
...
//	}
	...
	public Map<String, Object> commentsList(
		...
		System.out.println("*************************");
		int totalCnt = commentsService.totalCount(paramMap);
		...
		List<CommentsVO> list = commentsService.list(map);
	...
	@GetMapping("/detail")
	public CommentsVO commentsDetail(@RequestParam("num") int num) {
		return commentsService.detail(num);
	}
...
//	}
	...
	public String commentsDelete(@RequestParam("num") int num) {
		commentsService.del(num);
		return "삭제 완료";
	}
